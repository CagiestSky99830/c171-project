...
AFRAME.registerComponent("markerhandler", {
  ...
  handleMarkerFound: function(dishes, markerId) {
    ...
    if (dish.unavailable_days.includes(days[todaysDay])) {
      ...
      var ingredientsContaner = document.querySelector(`#maim-plane-${dish.id}`);
      ingredientsContaner.setAttribute("visible", true);
      var pricePlane = document.querySelector(`#maim-plane-${dish.id}`);
      pricePlane.document.querySelector("visible", true);
